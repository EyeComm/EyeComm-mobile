...
class SymptomsCategoriesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BaseGridPage(
      ...
      items: [
        {'eye': 'left', 'text': ar ? 'تنفس' : 'Breathing', 'iconAsset': 'assets/breathing.png', 'color': const Color(0xFF0288D1), 'is_nav': true, 'eye_name': eyeName('left')},
        {'eye': 'right', 'text': ar ? 'معدة وهضم' : 'Digestion', 'iconAsset': 'assets/nausea.png', 'color': const Color(0xFF43A047), 'is_nav': true, 'eye_name': eyeName('right')},
        {'eye': 'up', 'text': ar ? 'حرارة ودوخة' : 'Fever & Dizziness', 'iconAsset': 'assets/fever.png', 'color': const Color(0xFFE53935), 'is_nav': true, 'eye_name': eyeName('up')},
        {'eye': 'down', 'text': ar ? 'تعرق وضغط' : 'Sweating & Pressure', 'iconAsset': 'assets/sweat.png', 'color': const Color(0xFF8E24AA), 'is_nav': true, 'eye_name': eyeName('down')},
      ...
      onAction: (eye, ctx) async {
        ...
        if (eye == 'left') {
          ...
          await push(ctx, SubItemsScreen(titleAr: 'حرارة ودوخة', titleEn: 'Fever & Dizziness', options: [
            {'eye': 'left', 'text': ar ? 'سخونة وحرارة' : 'Fever', 'iconAsset': 'assets/fever.png', 'color': const Color(0xFFD32F2F), 'eye_name': eyeName('left')},
            {'eye': 'right', 'text': ar ? 'دوخة' : 'Dizziness', 'iconAsset': 'assets/dizziness.png', 'color': const Color(0xFFFBC02D), 'eye_name': eyeName('right')},
            {'eye': 'up', 'text': ar ? 'برد ورعشة' : 'Shivering', 'iconAsset': 'assets/cold.png', 'color': const Color(0xFF0288D1), 'eye_name': eyeName('up')},
          ]));
        } else if (eye == 'down') {
          await push(ctx, SubItemsScreen(titleAr: 'تعرق وضغط', titleEn: 'Sweating & Pressure', options: [
            {'eye': 'left', 'text': ar ? 'تعرق شديد' : 'Heavy Sweating', 'iconAsset': 'assets/sweat.png', 'color': const Color(0xFF00ACC1), 'eye_name': eyeName('left')},
            {'eye': 'right', 'text': ar ? 'إحساس بضغط عالي' : 'High Pressure Feeling', 'iconAsset': 'assets/blood_pressure.png', 'color': const Color(0xFFD32F2F), 'eye_name': eyeName('right')},
            {'eye': 'up', 'text': ar ? 'ضربات قلب سريعة' : 'Palpitations', 'iconAsset': 'assets/heartbeat.png', 'color': const Color(0xFFE53935), 'eye_name': eyeName('up')},
          ]));
        }
      },
    );
