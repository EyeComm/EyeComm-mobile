...
class ComfortScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BaseGridPage(
      ...
      items: [
        {'eye': 'left', 'text': ar ? 'تعديل وضعيتي' : 'Change Position', 'iconAsset': 'assets/pillow.png', 'color': const Color(0xFF8E24AA), 'is_nav': false, 'eye_name': eyeName('left')},
        {'eye': 'up', 'text': ar ? 'أشعر بالحر' : 'I Feel Hot', 'iconAsset': 'assets/hot.png', 'color': const Color(0xFFE53935), 'is_nav': false, 'eye_name': eyeName('up')},
        {'eye': 'right', 'text': ar ? 'أشعر بالبرد' : 'I Feel Cold', 'iconAsset': 'assets/cold.png', 'color': const Color(0xFF1E88E5), 'is_nav': false, 'eye_name': eyeName('right')},
        {'eye': 'down', 'text': ar ? 'أشعر بحكة' : 'I Feel Itchy', 'iconAsset': 'assets/itchy.png', 'color': const Color(0xFFF4511E), 'is_nav': false, 'eye_name': eyeName('down')},
